...
//create thorns
thorns1=new Obstacle2(320,400,60,30)
thorns2=new Obstacle2(650,440,60,30)
thorns3=new Obstacle2(1590,260,60,30)
thorns4=new Obstacle2(1790,160,60,30)
thorns5=new Obstacle2(6790,240,60,30)
thorns6=new Obstacle2(2390,240,60,30)
thorns7=new Obstacle2(5000,240,60,30)
thorns8=new Obstacle2(3800,240,60,30)
thorns9=new Obstacle2(4400,240,60,30)
thorns10=new Obstacle2(4890,240,60,30)
thorns11=new Obstacle2(7000,240,60,30)
thorns12=new Obstacle2(5400,340,60,30)
thorns13=new Obstacle2(5600,240,60,30)
...
door=createSprite(7270,400,200,50)
...
if(fireBallGroup.isTouching(kid)||kid.y==500){
 life=life-1;
 console.log(life)
}
...
function keyPressed(){
  ...
  if(keyCode===70){
    sword=createSprite(kid.x,kid.y,10,10)
